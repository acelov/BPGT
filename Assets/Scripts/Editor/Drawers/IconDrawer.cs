...
namespace BlockPuzzleGameToolkit.Scripts.Editor.Drawers
{
    ...
    public class IconDrawer : PropertyDrawer
    {
        ...
        {
            EditorApplication.delayCall += () => { m_Icon.style.backgroundImage = EditorUtils.GetCanvasPreviewVisualElement(m_IconScriptable.prefab, obj => obj.FillIcon(m_IconScriptable)); };
        }
    }
}