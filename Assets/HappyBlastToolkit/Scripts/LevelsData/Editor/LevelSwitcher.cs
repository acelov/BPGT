...
public class LevelSwitcher : VisualElement
{
    ...
    public LevelSwitcher(SerializedObject levelSerializedObject, Level level, LevelEditor levelEditor)
    {
        ...
        Draw(AssetDatabase.LoadAssetAtPath<VisualTreeAsset>(PathConstants.LevelSwitcher).Instantiate());
    }
    ...
    private void DelLevel()
    {
        ...
        if (levelsNum > 1)
        {
            var scenePath = $"{PathConstants.Levels}/Level_{levelsNum}.asset";
    ...
    private void NewLevel()
    {
        ...
        var path = $"{PathConstants.Levels}/Level_{levelsNum}.asset";
